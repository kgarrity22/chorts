      ...
      "on": [
        {
          ...
          "update": "tooltip ? [invert('xscale', (tooltip.bounds.x1 + tooltip.bounds.x2) / 2), invert('yscale', (tooltip.bounds.y1 + tooltip.bounds.y2) / 2)] : [0,0]"
        }
      ]
    },
    {
      ...
      "on": [
        {
          "events": {"type": "click", "markname": "circles"},
          "update": "tooltip ? [[invert('xscale', tooltip.bounds.x1), invert('xscale',tooltip.bounds.x2)], [invert('yscale', tooltip.bounds.y1), invert('yscale',tooltip.bounds.y2)]] : [0,0]"
        }
      ]
    },
    {
      ...
      "on": [
        {
          ...
          "update": "clicked ? pow(1.001, -tEase*100 * pow(16, 0)) : pow(1.001, tEase*100 * pow(16, 0))"
        }
      ]
    },
    {
      ...
      "on": [
        {
          "events": {"signal": "zoom"},
          "update": "[anchor3[0][0] + (xdom[0] - anchor3[0][0]) * zoom, anchor3[0][1] + (xdom[1] - anchor3[0][1]) * zoom]"
        }
      ]
    },
    {
      ...
      "on": [
        {
          "events": {"signal": "zoom"},
          "update": "[anchor3[1][1] + (ydom[0] - anchor3[1][1]) * zoom, anchor3[1][0] + (ydom[1] - anchor3[1][0]) * zoom]"
        }
      ]
    },
